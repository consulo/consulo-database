...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2020-08-18")
public class JdbcColum implements org.apache.thrift.TBase<JdbcColum, JdbcColum._Fields>, java.io.Serializable, Cloneable, Comparable<JdbcColum> {
  ...
  static {
    schemes.put(StandardScheme.class, new JdbcColumStandardSchemeFactory());
    schemes.put(TupleScheme.class, new JdbcColumTupleSchemeFactory());
  }
  ...
  public JdbcColum setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public JdbcColum setType(String type) {
    this.type = type;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JdbcColum(");
    boolean first = true;
  ...
  private static class JdbcColumStandardSchemeFactory implements SchemeFactory {
    public JdbcColumStandardScheme getScheme() {
      return new JdbcColumStandardScheme();
    }
  }

  private static class JdbcColumStandardScheme extends StandardScheme<JdbcColum> {
  ...
  private static class JdbcColumTupleSchemeFactory implements SchemeFactory {
    public JdbcColumTupleScheme getScheme() {
      return new JdbcColumTupleScheme();
    }
  }

  private static class JdbcColumTupleScheme extends TupleScheme<JdbcColum> {
