...
public class JdbcExecutor {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_runQuery(String query, List<JdbcValue> params) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class runQuery_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String query;
      private List<JdbcValue> params;
      public runQuery_call(String query, List<JdbcValue> params, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
        this.params = params;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class runQuery<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, runQuery_args, JdbcQueryResult> {
      ...
      public AsyncMethodCallback<JdbcQueryResult> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<JdbcQueryResult>() { 
...
;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<JdbcTable>(_list50.size);
                  JdbcTable _elem51;
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<JdbcTable>(_list55.size);
            JdbcTable _elem56;
  ...
  public static class runQuery_args implements org.apache.thrift.TBase<runQuery_args, runQuery_args._Fields>, java.io.Serializable, Cloneable, Comparable<runQuery_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new runQuery_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new runQuery_argsTupleSchemeFactory());
    }

    public String query; // required
    public List<JdbcValue> params; // required
    ...
    public runQuery_args(runQuery_args other) {
      ...
      if (other.isSetParams()) {
        List<JdbcValue> __this__params = new ArrayList<JdbcValue>(other.params.size());
    ...
    public runQuery_args setQuery(String query) {
      this.query = query;
      return this;
    }
    ...
    public void addToParams(JdbcValue elem) {
      if (this.params == null) {
        this.params = new ArrayList<JdbcValue>();
      }
      this.params.add(elem);
    }

    public List<JdbcValue> getParams() {
      return this.params;
    }

    public runQuery_args setParams(List<JdbcValue> params) {
      this.params = params;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PARAMS:
        if (value == null) {
          ...
          setParams((List<JdbcValue>)value);
        }
        break;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("runQuery_args(");
      boolean first = true;
    ...
    private static class runQuery_argsStandardSchemeFactory implements SchemeFactory {
      public runQuery_argsStandardScheme getScheme() {
        return new runQuery_argsStandardScheme();
      }
    }

    private static class runQuery_argsStandardScheme extends StandardScheme<runQuery_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.params = new ArrayList<JdbcValue>(_list58.size);
                  JdbcValue _elem59;
    ...
    private static class runQuery_argsTupleSchemeFactory implements SchemeFactory {
      public runQuery_argsTupleScheme getScheme() {
        return new runQuery_argsTupleScheme();
      }
    }

    private static class runQuery_argsTupleScheme extends TupleScheme<runQuery_args> {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.params = new ArrayList<JdbcValue>(_list63.size);
            JdbcValue _elem64;
  ...
  public static class runQuery_result implements org.apache.thrift.TBase<runQuery_result, runQuery_result._Fields>, java.io.Serializable, Cloneable, Comparable<runQuery_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new runQuery_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new runQuery_resultTupleSchemeFactory());
    }

    public JdbcQueryResult success; // required
    public FailError fr; // required
    ...
    public runQuery_result setSuccess(JdbcQueryResult success) {
      this.success = success;
      return this;
    }
    ...
    public runQuery_result setFr(FailError fr) {
      this.fr = fr;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("runQuery_result(");
      boolean first = true;
    ...
    private static class runQuery_resultStandardSchemeFactory implements SchemeFactory {
      public runQuery_resultStandardScheme getScheme() {
        return new runQuery_resultStandardScheme();
      }
    }

    private static class runQuery_resultStandardScheme extends StandardScheme<runQuery_result> {
    ...
    private static class runQuery_resultTupleSchemeFactory implements SchemeFactory {
      public runQuery_resultTupleScheme getScheme() {
        return new runQuery_resultTupleScheme();
      }
    }

    private static class runQuery_resultTupleScheme extends TupleScheme<runQuery_result> {
