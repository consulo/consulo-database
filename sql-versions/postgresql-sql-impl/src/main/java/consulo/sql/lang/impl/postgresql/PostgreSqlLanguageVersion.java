 ...
 */
@ExtensionImpl
public class PostgreSqlLanguageVersion extends BaseSqlLanguageVersion {
    public PostgreSqlLanguageVersion() {
        super("PostgreSQL", "PostgreSQL");

        registerKeywords(Sql92TokenTypes.RESERVED_KEYWORDS);
        registerKeywords(PostgreSqlTokenTypes.RESERVED_KEYWORDS);
    }
