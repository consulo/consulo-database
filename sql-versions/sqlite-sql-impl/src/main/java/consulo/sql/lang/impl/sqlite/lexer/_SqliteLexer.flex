package consulo.sql.lang.impl.sqlite.lexer;
...
<YYINITIAL> {BACKTICK_QUOTED_IDENTIFIER} { return SqlTokenType.BACKTICK_QUOTED_IDENTIFIER; }

<YYINITIAL> {BRACKET_QUOTED_IDENTIFIER} { return SqlTokenType.BRACKET_QUOTED_IDENTIFIER; }
